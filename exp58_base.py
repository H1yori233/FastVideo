"""exp58: REVERT to base recipe (NO value-anchor) — single, MOVING character.
The value-anchor (vhold) ghosts (frozen double-image); DINO metric falsely rewarded
it. Base recipe = sink1/win6, feathered boost4, qsupp6, mid-layer-gate 0.2-0.8,
sigma(5,5), vhold=0. Non-humanoids clean. NF=297, action W, seed42.
"""
import time
...
def main():
    ...
    for tag, img, box in CASES:
        ...
        out = f"attn_injection_out/exp58_base/{tag}"
        t0 = time.time()
        gen.generate_video(
