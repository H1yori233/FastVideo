...
OUT=Path("/home/hal-kaiqin/FastVideo_attninj/attn_injection_out/exp40_vbox")
H,W,NF=480,832,201
...
def main():
    ...
    for box,boost,sig,tag in [((10,30,23,30),4.0,(8.0,4.0),"vtall_b4"),((10,30,23,30),5.0,(8.0,4.0),"vtall_b5")]:
