...
OUT=Path("/home/hal-kaiqin/FastVideo_attninj/attn_injection_out/exp38_fullbody")
H,W,NF=480,832,201
...
def main():
    ...
    for box,boost,sig,tag in [((10,29,19,33),4.0,(7.0,8.0),"full_b4"),((10,29,19,33),5.0,(7.0,8.0),"full_b5")]:
