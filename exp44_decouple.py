...
OUT=Path("/home/hal-kaiqin/FastVideo_attninj/attn_injection_out/exp44_decouple")
H,W,NF=480,832,201
def w_setup(worker,qsupp):
    ...
    INJECTOR.start_fg_sink(); INJECTOR.fg_boost=4.0; INJECTOR.fg_qsupp=qsupp
    INJECTOR.layer_lo=0.2; INJECTOR.layer_hi=0.8; INJECTOR.fg_boost_ramp=0.0
    return qsupp
...
def main():
    ...
    for qs,kbs,tag in [(2.0,2.0,"q2_kb2"),(2.0,3.0,"q2_kb3"),(3.0,2.0,"q3_kb2")]:
        rpc(gen,w_setup,qs); kb=torch.from_numpy(kb0*kbs); t0=time.time()
