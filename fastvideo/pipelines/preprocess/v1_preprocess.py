...
def main(args) -> None:
    ...
    elif args.preprocess_task == "matirxgame_ode_trajectory":
        PreprocessPipeline = PreprocessPipeline_MatrixGame_ODE_Trajectory
    else:
        raise ValueError(
            f"Invalid preprocess task: {args.preprocess_task}. "
            f"Valid options: t2v, i2v, ode_trajectory, text_only, matrixgame, matirxgame_ode_trajectory")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="t2v",
        choices=["t2v", "i2v", "text_only", "ode_trajectory", "matrixgame", "matirxgame_ode_trajectory"],
