...
OUT=Path("/home/hal-kaiqin/FastVideo_attninj/attn_injection_out/exp43_ramp")
H,W,NF=480,832,201
def w_setup(worker,ramp):
    ...
    INJECTOR.fg_boost_ramp=ramp; INJECTOR.fg_boost_max=9.0
    return ramp
...
def main():
    ...
    for ramp,tag in [(0.0,"ramp0"),(0.02,"ramp02"),(0.04,"ramp04")]:
        rpc(gen,w_setup,ramp); t0=time.time()
