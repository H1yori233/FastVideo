...
OUT=Path("/home/hal-kaiqin/FastVideo_attninj/attn_injection_out/exp35_layers")
H,W,NF=480,832,201
def w_setup(worker):
    ...
    return True
def w_band(worker,lo,hi):
    from fastvideo.models.dits.matrixgame2.attn_injection import INJECTOR
    INJECTOR.layer_lo=lo; INJECTOR.layer_hi=hi; return (lo,hi)
...
def main():
    ...
    for lo,hi,tag in [(0.0,1.0,"all"),(0.2,0.8,"mid20_80"),(0.35,0.7,"mid35_70")]:
        rpc(gen,w_band,lo,hi); t0=time.time()
